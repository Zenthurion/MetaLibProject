...
{
    public abstract class MInventory : IInventory
    {
        ...
        protected MInventory(IStorageCapacityProvider capacityProvider = null)
        {
            Contents = new List<IInventoryItem>();
            
            CapacityProvider = capacityProvider ?? new MSimpleStorageCapacityProvider(10);
        }
